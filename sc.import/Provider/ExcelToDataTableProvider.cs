...
namespace sc.import
{
    public static class ExcelToDataTableProvider
    {
        ...
        public static DataTable ToDataTable(this Stream stream, bool hasHeaderRow = true)
        {
            using (var package = new ExcelPackage(stream))
            {
                return package.Workbook.Worksheets.First().ToDataTable(hasHeaderRow);
            }
        }
    }
}
